	...
	return (
		<>
			<footer className="container h-2/4 py-6 md:py-[60px] text-secondary-100 text-base font-lato">
				{/* <div className="flex flex-row gap-[92px] justify-between">
					<div className="flex flex-col gap-8 w-[375px]">
						<img
							className="w-[162px] h-[34.8px]"
							src={RedTechLogo}
							alt="redtech-logo"
						/>
					...
					<div className="flex flex-col gap-6 bg-blue-gray-500">
				...
				<div className="flex flex-col gap-8 md:flex-row md:gap-[92px] justify-between">
