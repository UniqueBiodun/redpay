		...
		<div>
			{isMobile ? (
				<section className="w-full flex min-h-[90vh] items-center font-grotesk bg-benefitBg bg-no-repeat bg-cover">
					<div className="container py-10 md:py-0 px-4 lg:px-0 flex flex-col lg:pl-[10.8rem] lg:flex-row justify-between items-center gap-16">
						<div className="w-full lg:h-[680px] flex flex-col gap-16 lg:gap-64 lg:py-64 lg:overflow-auto lg:scrollbar-hide">
						...
						<div className="hidden lg:inline-block w-full h-full"></div>
					</div>
				</section>
			) : (
							...
							>
								<div className={`${styles.card} ${styles.parallax}`}>
									<div className="w-full">
										...
										>
											Empower your{" "}
											<span className="text-primary">customers</span> with
											versatile payment choices
										</p>
										<p
											className={`pt-2 pb-[2.5rem] text-secondary-300 text-base w-full`}
										>
											Your customers deserve convenience, and our diverse
											payment methods ensure they can shop, pay, and transact in
											the way that suits them best. Make paying a breeze for
											them by offering a variety of payment options like cards,
								...
								<div className={`${styles.card} ${styles.parallax}`}>
									<div className="w-full">
										...
										<p
											className={`pt-2 pb-[2.5rem] text-secondary-300 text-base w-full`}
										>
											Free up resources with automated payments and manage
											payroll, subscriptions, and invoices easily, allowing your
							...
							>
								<div className={`${styles.card} ${styles.parallax}`}>
									<div className="w-full">
										...
										>
											With T+1 settlement and a dedicated merchant dashboard
											offering robust reporting, dispute resolution, and
											analytics tools, your customers will enjoy a seamless
											journey and your business will thrive.
										</p>
										<Link to="#">
											<span
												className={`flex flex-row gap-2 items-center text-base text-primary `}
							...
							>
								<div className={`${styles.card} ${styles.parallax}`}>
									<div className="w-full">
										...
										>
											Unlock actionable{" "}
											<span className="text-primary">insights</span> to fuel
											your growth
										</p>
										<p
											className={`pt-2 pb-[2.5rem] text-secondary-300 text-base w-full `}
										>
											Gain priceless insights into your business performance
											through comprehensive reporting and analytics. Your growth
											journey is powered by data. Put your customers' needs and
											preferences at the heart of everything you do with
											informed decisions and fine-tuned strategies.
										</p>
										<Link to="#">
											<span
												className={`flex flex-row gap-2 items-center text-base text-primary `}
								...
								<div className={`${styles.card} ${styles.parallax}`}>
									<div className="w-full">
										...
										<p
											className={`pt-2 pb-[2.5rem] text-secondary-300 text-base w-full`}
										>
											Enhance your adaptability and expand your reach by
											integrating our payment system with PoS systems,
											e-commerce modules, and virtual accounts, ensuring your
											customers' needs are met at every step.
										</p>
										<Link to="#">
											<span
												className={`flex flex-row gap-2 items-center text-base text-primary `}
							...
							>
								<div className={`${styles.card} ${styles.parallax}`}>
									<div className="w-full">
										...
										>
											Integrate with a{" "}
											<span className="text-primary">smile</span>+ support
										</p>
										<p
											className={`pt-2 pb-[2.5rem] text-secondary-300 text-base w-full`}
										>
											Our API Documentation is here to simplify your journey,
											providing clear guides. What's more, we're with you every
											step of the way, ensuring a friendly and smooth
											integration process. But that's not all. Redpay's 24/7
											support system ensures that help is just a message or call
											away, making your integration experience truly
											exceptional.
										</p>
										<Link to="#">
											<span
